...
public class Main {
    ...
    public static void main(String[] args) {
        ...
        alice.setPassword("thisIsPassword");

        User aliceSecond = new User();
        aliceSecond.setEmail("alice@mail");
        aliceSecond.setPassword("qwerty");
        ...
        try {
            authenticationService.register(aliceSecond.getEmail(), aliceSecond.getPassword());
        } catch (RegistrationException e) {
            System.out.println(e);
        }
        try {
