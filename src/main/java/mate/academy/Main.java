...
public class Main {
    ...
    public static void main(String[] args) {
        ...
        String hardcodeEmail = "testemail@domain";
        String hardcodePass = "testpass";
        AutheticationService autheticationService =
                (AutheticationService) injector.getInstance(AutheticationService.class);
        try {
            autheticationService.register(hardcodeEmail, hardcodePass);
        } catch (RegistrationException e) {
            throw new RuntimeException("Cannot register user", e);
        }
        try {
            autheticationService.login(hardcodeEmail, hardcodePass);
