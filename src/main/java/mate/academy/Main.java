...
public class Main {
    ...
    public static void main(String[] args) {
        ...
        try {
            System.out.println(authenticationService.register("Mate@gamil.com","12345qwert"));
            System.out.println(authenticationService.register("Academy@gamil.com","qwert"));
            System.out.println(authenticationService.register("LOLIPOP123f@gamil.com","098765dfde"));
        } catch (RegistrationException e) {
            throw new RuntimeException(e);
        }

        try {
            System.out.println(authenticationService.login("Mate@gamil.com","12345qwert"));
