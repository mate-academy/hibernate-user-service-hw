...
public class Main {
    ...
    public static void main(String[] args) {
        ...
        User firstUser = new User("userOne@gmail.com", "passwordUserOne");
        User secondUser = new User("userTwo@gmail.com", "passwordUserTwo");

        var userService = (UserService) injector.getInstance(UserService.class);
        userService.add(firstUser);
        userService.add(secondUser);
        System.out.println(userService.findByEmail("userOne@gmail.com"));

        var authenticationService
                = (AuthenticationService) injector.getInstance(AuthenticationService.class);
        System.out.println(authenticationService
                .login("userOne@gmail.com", "passwordUserOne"));
        authenticationService.register("", "mastyrbeastPassword");
    }
}
