...
public class Main {
    ...
    public static void main(String[] args) {
        ...
        String emailForRegister = "bill@gmail.com";
        String passwordForRegister = "123qwe";

        try {
            authenticationService.register(emailForRegister, passwordForRegister);
            System.out.println("Register successful with email " + emailForRegister);
