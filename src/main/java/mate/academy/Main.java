...
public class Main {
    ...
    public static void main(String[] args) {
        ...
        userService.add(new User("test@ukr.net", "gwerty"));
        System.out.println(userService.findByEmail("test@ukr.net"));
        try {
            System.out.println(authenticationService.login("test@ukr.net", "gwerty"));
