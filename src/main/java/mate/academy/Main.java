...
public class Main {
    ...
    public static void main(String[] args) throws RegistrationException, AuthenticationException {
        ...
        User bob = new User("bob@yahoo.com", "qwerty");
        User alice = new User("alice@yahoo.com", "qwerty");
        User registeredBob = authenticationService.register("bob@yahoo.com", "qwerty");
        System.out.println(registeredBob.getPassword());
        User userBob = authenticationService.login("bob@yahoo.com", "qwerty");
        System.out.println(userBob.getPassword());
    }
}
