...
public class Main {
    ...
    public static void main(String[] args) {
        ...
        try {
            registeredUser = authenticationService.register("newUserMail@gmail.com", "dre5397");
            System.out.println("Ok. New user with email newUserMail@gmail.com was registered.");
        } catch (RegistrationException e) {
            throw new RuntimeException("Can't register user.", e);
        }
        try {
            authenticationService.login("newUserMail@gmail.com", "dre5397");
            System.out.println("Ok. User was logged in with valid email and password.");
        } catch (AuthenticationException e) {
            throw new RuntimeException("Can't authenticate user.", e);
        }
        System.out.println("Registered user password: " + registeredUser.getPassword());
    }
}
