...
public class Main {
    ...
    public static void main(String[] args) throws AuthenticationException, RegistrationException {
        ...
        System.out.println(userService.findByEmail("Bohdan"));

        AuthenticationService authenticationService = (AuthenticationService)
                injector.getInstance(AuthenticationService.class);
        System.out.println(authenticationService.register("Tania", "12345"));
        System.out.println(authenticationService.login("Tania", "12345"));
    }
}
