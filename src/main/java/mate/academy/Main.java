...
public class Main {
    ...
    public static void main(String[] args) {
        ...
        User firstUser = new User("Kirito@gmail.com", "123unsafe54");
        User secondUser = new User("Alice@gmail.com", "0test_pass0");
        ...
        try {
            ...
            System.out.println("Register exception checked");
        }
        try {
            authenticationService.login(firstUser.getEmail(), secondUser.getPassword());
        } catch (AuthenticationException ex) {
            System.out.println("Authentication exception checked");
        }
    }
}
