...
public class Main {
    ...
    public static void main(String[] args) throws AuthenticationException, RegistrationException {
        ...
        User userOne = new User("firstEmail", "firstPassword");
        userService.add(userOne);
        System.out.println(userService.findByEmail(userOne.getEmail()));
        AuthenticationService authenticationService
                = (AuthenticationService) injector.getInstance(AuthenticationService.class);
        System.out.println(authenticationService.register("secondEmail", "secondPassword"));
        System.out.println(authenticationService.register("thirdEmail", "thirdPassword"));
        System.out.println(authenticationService.login("firstEmail", "firstPassword"));
    }
}
