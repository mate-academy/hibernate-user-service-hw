...
public class Main {
    ...
    public static void main(String[] args) {
        ...
        userBob.setLogin("Bob@gmail.com");
        userBob.setPassword("Bob1234");

        UserService userService = (UserService) injector.getInstance(UserService.class);
        System.out.println("Save user Bob!");
        userService.add(userBob);
        System.out.println("Find user Bob by email!");
        Optional<User> optionalUser = userService.findByEmail(userBob.getLogin());
