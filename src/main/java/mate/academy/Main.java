...
public class Main {
    public static void main(String[] args) {
        ...
        try {
            authenticationService.register("zuzo@meta.ua", "123456");
            // authenticationService.register("zuzo@meta.ua", "654321");
            authenticationService.register("zaza@meta.ua", "456789");
        } catch (RegistrationException e) {
            throw new RuntimeException("Try different email", e);
        }
