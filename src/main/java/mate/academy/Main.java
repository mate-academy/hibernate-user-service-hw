...
public class Main {
    ...
    public static void main(String[] args) throws RegistrationException, AuthenticationException {
        ...
        String emailBob = "bob@mail.ua";
        String passwordBob = "qwerty";
        authenticationService.register(emailBob, passwordBob);
        System.out.println(authenticationService.login("bob@mail.ua", "qwerty"));
        System.out.println(authenticationService.login("bob@gmail.ua", "qwerty"));
        System.out.println(authenticationService.login("bob@mail.ua", "qwertt"));
    }
}
