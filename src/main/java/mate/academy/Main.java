...
public class Main {
    ...
    public static void main(String[] args) throws RegistrationException, AuthenticationException {
        ...
        //Register user with valid data to DB and return saved user.
        System.out.println(authenticationService.register("Oleh@gmail.com", "password"));

        //Register user with the same email. We will get exception
        //System.out.println(authenticationService.register("Oleh@gmail.com", "password"));

        //login user by correct data
