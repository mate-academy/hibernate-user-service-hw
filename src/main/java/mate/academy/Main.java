...
public class Main {
    ...
    public static void main(String[] args) {
        ...
        User bob = new User();
        bob.setLogin("bob@email.com");
        bob.setPassword("bob1234");
        User registeredUser = null;
        try {
            registeredUser = authenticationService.register(bob.getLogin(), bob.getPassword());
        ...
        try {
            ...
            throw new RuntimeException("Can't login to the system", e);
        }
        try {
