...
public class Main {
    ...
    public static void main(String[] args) throws AuthenticationException {
        ...
        User ben = new User("ben@gmail.com", "matrix125");
        User viktor = new User("viktor@gmail.com", "dfhlmdh43tgs");
        User petro = new User("petro@gmail.com", "tttwfsgsd");
        
        userService.add(ben);
        userService.add(viktor);
        userService.add(petro);
        
        authenticationService.register("antonio@gmail.com", "7asdas894");
