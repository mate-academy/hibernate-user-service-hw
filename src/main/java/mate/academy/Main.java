...
public class Main {
    public static void main(String[] args) {
        ...
        try {
            User john = authenticationService.register("john_doe@gmail.com", "qwerty");
            User alice = authenticationService.register("alice@gmail.com", "alice");

            User loginedJohn = authenticationService.login(john.getEmail(), "qwerty");
            User loginedAlice = authenticationService.login(alice.getEmail(), "alice");
            System.out.println(loginedAlice);
            System.out.println(loginedJohn);
