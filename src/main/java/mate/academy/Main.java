...
public class Main {
    ...
    public static void main(String[] args) {
        ...
        User userBob = new User("bob@gmail.com", "qwerty");
        ...
        try {
            User loggedUser = authenticationService.login("bob@gmail.com",
                    "qwerty");
        ...
        try {
            User registeredUser = authenticationService.register("bob1@gmail.com",
                    "qwertys");
