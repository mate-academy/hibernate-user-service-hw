...
public class Main {
    public static void main(String[] args) {
        ...
        User user = new User();
        user.setLogin("sema123@gmail.com");
        user.setPassword("qwerty");

        AuthenticationService authenticationService = (AuthenticationService)
                instance.getInstance(AuthenticationService.class);
        try {
            User register = authenticationService.register(user.getLogin(), user.getPassword());
        ...
        try {
            User login = authenticationService.login(user.getLogin(), user.getPassword());
